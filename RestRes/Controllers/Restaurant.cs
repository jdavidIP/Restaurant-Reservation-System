...
namespace RestRes.Controllers
{
    public class RestaurantController : Controller
    {
        ...
        public IActionResult Delete(Restaurant restaurant)
        {
            ...
            {
                ViewData["Error Message"] = "Deleting the restaurant failed, ID invalid";
                return View();
            }
            ...
            try
            {
                ...
                TempData["RestaurantDeleted"] = "Restaurant deleted succesfully";

                return RedirectToAction("Index");
            }
            catch (Exception ex)
            {
                ViewData["ErrorMessage"] = $"Deleting the restaurant failed, please try again! Error: {ex}";
            }
